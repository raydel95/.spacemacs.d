...
values."
  ...
  (setq-default
   ...
   ;; Theme is 'spacemacs, 'all-the-icons, 'custom, 'vim-powerline or
   ;;'vanilla or a list with `car' one of the previous values and
   ;; properties one of the following: `:separator' or `:separator-scale'
